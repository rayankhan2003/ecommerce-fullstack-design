...
import { Heart, Grid3X3, List, Star, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function ProductListing() {
  ...
  const activeFilters = ["Samsung", "Apple", "Pocco", "Xiaomi", "4 star", "3 star"]

  return (
    <div className="mx-auto py-6" style={{ width: "1180px" }}>
      {/* Breadcrumb */}
      <div className="text-sm text-gray-500 mb-4">Home &gt; Clothings &gt; Men's wear &gt; Summer clothing</div>
      ...
      <div className="flex gap-6">
        ...
        <div className="w-64 space-y-6">
          ...
          <div>
            ...
            <Button className="w-full mt-2 bg-blue-600 hover:bg-blue-700">Apply</Button>
          </div>
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center space-x-2 mb-4">
            ...
            <button className="text-sm text-blue-600 hover:underline">Clear all filter</button>
          </div>
              ...
              <div key={product.id} className="bg-white rounded-lg border p-4 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    {product.freeShipping && <span className="text-xs text-green-600">Free Shipping</span>}
                  </div>
                  <Link href={`/product/${product.id}`}>
                    <h3 className="text-sm text-gray-700 line-clamp-2 hover:text-blue-600">{product.name}</h3>
                  </Link>
